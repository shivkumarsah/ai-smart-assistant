...
from ciena.models import Tickets
...
def update(request):
    ...
    try:
        ...
        if request.method == 'POST':
            ticket = Tickets()
            ticket.subject = request.POST['query']
